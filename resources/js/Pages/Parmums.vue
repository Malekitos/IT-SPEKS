...
<template>
    ...
    <Welcome>
        ...
        <div class="relative flex justify-center">
            <img src="../../photos/background.jpeg" class="blur-sm brightness-50 w-full h-auto object-cover max-[600px]:hidden">
            <div class="absolute">
                <h1 class="font-bold text-white text-8xl mt-40 max-[600px]:bg-main max-[600px]:text-6xl max-[600px]:mt-14">IT-SPEKS</h1>
