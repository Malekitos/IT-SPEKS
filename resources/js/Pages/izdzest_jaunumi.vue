<template>
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                            <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                                Jaunumu dzēšana :  {{jaunums.nosaukums}} 
                            </h3>
                        ...
                        <div class="flex items-center p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                            <button v-on:click="toggleModal()"  @click="removeJaunums()" type="button" class="btn mr-12 border-0 text-white bg-orange-500  hover:bg-orange-600">Izdzēst</button>
  ...
  export default {
    ...
    setup() {
      ...
      const izdzests = () => {
                toast("Jaunums ir veiksmīgi izdzēsts!", {
        "theme": "colored",
        "type": "error",
        "transition": "flip",
    ...
    removeJaunums(){
            axios.delete('Jaunumi/remove/' + this.jaunums.id).then(response => { 
                this.izdzests()     
                    }).catch(errors => {
                    console.log(errors);
                });
