<template lang="">
    <div>
            ...
            <!-- Modal toggle -->
            <button v-on:click="toggleModal()" class="transition-all  inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-slate-500 hover:bg-slate-600">
                Lasīt vairāk
            </button>
