...
<!--Footer container-->
<footer
  class="flex flex-col items-center text-black text-center text-surface bg-whitem">
  ...
  <!--Copyright section-->
  <div class="w-full bg-main p-4 text-center text-white">
    © 2023 Copyright:
    <a href="/dashboard"><b>IT IR SPĒKS</b></a>
  </div>
</footer>
  </template>
