<template>
    <div>
            ...
            <!-- Modal toggle -->
            <button v-on:click="toggleModal()" class="transition-all  inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-orange-500 hover:bg-ogange-600 hover:bg-orange-600">
                Izdzēst
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                            <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                                Vakances dzēšana :  {{vakance.nosaukums}}
                            </h3>
                        ...
                        <div class="p-4 md:p-5 space-y-4">
                            ...
                            <dl class="max-w-md text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                                <h1 class="text-xl">Vai esat pārliecināts, ka vēlaties dzēst šo darba sludinājumu? <a class="underline decoration-red-500">Nav atcelšanas iespējas</a> </h1>
                        </dl>
